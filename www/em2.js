...
//          '2018Q1', '2018Q2', '2018Q3', '2018Q4'],  title: 'Year'} : {};
    ...
    $(document).on('updateNotes', function() {
      ...
      $(document).on('updateNotes', function () {
          ...
          // var SOURCE = dec ;
         // var NCHS = "National Center for Health Statistics. National Health Interview Survey Interactive Biannual Early Release Estimates Data Query Tool";
          ...
          var link = '<a href="https://www.cdc.gov/nchs/data/nhis/earlyrelease/earlyrelease202009_tech-508.pdf" target="_blank_">Technical Notes for Early Release Estimates Based on data from the National Health Interview Survey.</a >';
          //var link = "<a href=\\\"https:\/\/wwwndev.cdc.gov\/NHISDataQueryTool\/ER_Quarterly\/index_quarterly.html\\\" target=\\\"_blank_\\\">Biannual Early Release Estimates.<\/a>";
          var today2 = new Date();
          var today3 = new Date().toDateString().slice(4);
              var url = "Biannual Early Release Estimates";
              var url1 = "https://wwwndev.cdc.gov/NHISDataQueryTool/ER_Quarterly/index_quarterly.html";
             // var url2= '<a href="' + url + '">Link</a>';
          var url2 = url.link("https://wwwndev.cdc.gov/NHISDataQueryTool/ER_Quarterly/index_quarterly.html")
          var codeBlock = NCHS + ". " + tableCaption + ". " + NHIS +
              ". Generated interactively: " + today2.toDateString() +  "at:" +
              '<a href="https://wwwndev.cdc.gov/NHISDataQueryTool/ER_Biannual3/index_biannual.html" target="_blank_">Biannual Early Release Estimates.</a >';
          var codeBlock2 = '<a href="https://wwwndev.cdc.gov/NHISDataQueryTool/ER_Biannual3/index_biannual.html" target="_blank_">Biannual Early Release Estimates.</a >';
          //document.getElementById("source4").innerHTML = codeBlock
          //document.getElementById("source5").innerHTML = codeBlock2

          var today = new Date();
          //var newCitation = NCHS + ". " + tableCaption + ". " + NHIS +
         //     ". Generated interactively: " + today.toDateString() + "at:" + codeBlock;
