...
//        }
    ...
    $(document).ready(function () {
        ...
        if (selectedGroup === 'all') {
            // Combine all topics when "All Topics" is selected
            ...
            // Automatically select specific topics for Genetic and Sexual groups 
            if (selectedGroup === 'genetic') {
                topicFilter.value = 'Genetictesting31';
            } else if (selectedGroup === 'sexual') {
                topicFilter.value = 'Sexualhealth65';
    }
