...
//        var newstr = str.replaceAll(",","").replace("*","");
   ...
   //   height: height,
     ...
     // var ynum2= y_values2;
     // ynum2(y_values);
      //var ytest = y_values.map(toNumber);
      ...
      return index % 2 == 1;      });
        ...
        // var ses_i_test = selectIndexes(lcl_num_line2, keep_i);
     ...
     //  var lcltestit2 = lcltestit[k];
      //var testucl = lcl_num_line2[k];
//var a = y_segment,
//  b = lcl_num_line2,
  //LCL_line4 = [];

//for(var i = 0;i<=b.length-1;i++)
//  LCL_line4.push(a[i] - b[i]);

//   testsub=y_segment[j]- lcl_num_line2[j];
      


      var LCL_line = y_segment.map(function(num, idx) {return num - lcl_num_line2[idx];});
      var UCL_line = y_segment.map(function(num, idx) {return num - lcl_num_line2[idx];}); 
      ...
      var y_se = LCL_line.concat(UCL_line.reverse());
        // var y_se = lcl_num_line2.concat(ucl_num_line2.reverse());
