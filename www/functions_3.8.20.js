...
//        var newstr = str.replaceAll(",","").replace("*","");
   ...
   //   height: height,
     ...
     // var se_segment = se_split[k];
      ...
      var LCL_line3 = y_segment.map(function(num, idx) {return num - lcl_num_line2[idx];});
      var UCL_line3 = ucl_num_line2.map(function(num, idx) {return num - y_segment[idx];});

      var LCL_line = y_segment.map(function(num, idx) {return num - LCL_line3[idx];});
      var UCL_line = y_segment.map(function(num, idx) {return num + UCL_line3[idx];}); 
      var a = LCL_line;
      var b = UCL_line.reverse();
      var se_segment = a[k];
