...
//        var newstr = str.replaceAll(",","").replace("*","");
   ...
   //   height: height,
      ...
      var UCL_line = y_i_line.map(function(num, idx) {return num - UCL_line3[idx];}); 
            ...
            var UCL_line_test = UCL_line.reverse();
      ...
      var y_se2 = LCL_line.concat(UCL_line);
    ...
    //  },
      ...
      array: LCL_segment.map(function(x) {return x;}),
      arrayminus: UCL_segment.map(function(x) {return x;}),
      },
      text: ses_i[j],
