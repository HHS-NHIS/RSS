...
$(document).ready(function () {
    ...
    */
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
        $("div.round2 select").val("gyno_ov_remove");
    });
    });
    ...
    // DATA: update ---------------------------------------------------------------
    var newData, colNames, colClasses, stat_var, col_var, colX, row_var, rowX, stat_var2;
    ...
    $(document).on('updateValues', function () {
        ...
        // stat_var = $('.stat_var2').val();
        // stat_var = $('select.stat_var2').val();


        //stat_var3 = $("#Round1 option:selected").text();
        stat_var = stat_var2;
