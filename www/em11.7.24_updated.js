...
$(document).ready(function () {
    ...
    */
    ...
    $(function () {
        ...
        $(document).ready(function () {
            ...
            if ($("#year").val() == '2023, Aug-Round1') {
                ...
                $('#round2').val("-1");
            } else if ($("#year").val() == 'July-August, 2025') {
                $("div.round2 select").val("Lyme1");
                $('#round1').val("-1");
    ...
    var stat_var33;
    var stat_var3;
    // declare any_sG to avoid ReferenceError when conditional blocks do not run
    // (used later to detect subgroup names in selected question text)
    var any_sG = null;
    // initialize statName to avoid ReferenceError before it is first assigned
    var statName = '';
    $(document).ready(function () {
        $('#round2').change(function () {
    ...
    $(document).ready(function () {
        $("#year").change(function () {
            if ($(this).val() == '2023, Aug-Round1') {
                ...
                //stat_var3 = $("#round1 option:selected").val();
                //console.log(stat_var3)
            } else if ($(this).val() == 'July-August, 2025') {
                // $("#round2").val('adhd_two');
    ...
    $(document).on('updateData', function () {
        ...
        //            filename1 = 'air_cleaner_mold' + '__' + rowX + '__' + colX + '__' + subGrp;
        //            console.log(filename1);
        //        } else if ($("#year").val() == 'July-August, 2024') {
        //            //filename1 = $(stat_var3).val() + '__' + rowX + '__' + colX + '__' + subGrp;
        //            filename1 = 'adhd_two' + '__' + rowX + '__' + colX + '__' + subGrp;
        //            console.log(filename1);
        //        }
        ...
        $.getJSON(filename1 + '.json', function (data) {
            ...
            var grpName = rowX == 'ind' ? 'Round 7' : $('#row_var option:selected').text();
    ...
    $(document).on('updateNotes', function () {
        ...
        newSource = "<b>Source:</b> " + NCHS + ", " + RSS + ", Round 7, July-August, 2025";
        ...
        var newCitation = NCHS + ". " + titleCaption + ". " + RSS +
            ". Generated interactively: " + today3 + " from https://wwwndev.cdc.gov/NHISDataQueryTool/RSS7/index.html";
    ...
    $(document).ready(function () {
        $("select").change(function () {
            $("select option:selected").each(function () {
                ...
                if ($(this).attr("value") == "July-August, 2025") {
                    $(".box").hide();
                    $("#Round2").show();
                    stat_var33 = $("#round2 option:selected").text();
                    stat_var3 = $("#round2 option:selected").val();
    ...
    const topics = {
        Lyme: [
            { group: 'Lyme disease prevention', value: 'Lyme1', text: 'Annual vaccine' },
            { group: 'Lyme disease prevention', value: 'Lyme2', text: 'Single dose of antibiotics' },
            { group: 'Lyme disease prevention', value: 'Lyme3', text: 'Bug spray' },
            { group: 'Lyme disease prevention', value: 'Lyme4', text: 'Clothing pretreated with permethrin' }
        ],
        GLP: [
            { group: 'GLP-1 medications access and use', value: 'GLP5', text: 'Use of any GLP-1 medication, past 12 months' },
            { group: 'GLP-1 medications access and use', value: 'GLP6', text: 'Currently using any GLP-1 medication' },
            { group: 'GLP-1 medications access and use', value: 'GLP7', text: 'Use of any compounded version of GLP-1 medication' },
            { group: 'GLP-1 medications access and use', value: 'GLP19', text: 'Had a prescription for GLP-1 medication' },
            { group: 'GLP-1 medications access and use', value: 'GLP22', text: 'Health insurance paid for some or all of the cost of GLP-1 medication' },                                                

            { group: 'Where received GLP-1 medication from', value: 'GLP8', text: 'Primary care doctor or specialist, filled at a pharmacy' },
            { group: 'Where received GLP-1 medication from', value: 'GLP9', text:  'Online provider' },
            { group: 'Where received GLP-1 medication from', value: 'GLP10', text: 'Online company that only provides medication' },
            { group: 'Where received GLP-1 medication from', value: 'GLP11', text: 'Medical spa or cosmetic medical center' },
            { group: 'Where received GLP-1 medication from', value: 'GLP12', text: 'Somewhere else' },

            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP13', text: 'Any alteration' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP20', text: 'Any alteration because was not available' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP21', text: 'Any alteration due to cost' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP14', text: 'Skipped doses' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP15', text: 'Took less than prescribed' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP16', text: 'Delayed filling a prescription' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP18', text: 'Reduced or stopped due to any side effects or symptoms' },
            { group: 'Alterations in dose of GLP-1 medications', value: 'GLP17', text: 'Stopped taking medication entirely' }
                                                
        ],
        Lung: [
            { group: 'Lung cancer screening', value: 'Lung19', text: 'Doctor discussed benefits of lung cancer screening' },
            { group: 'Lung cancer screening', value: 'Lung20', text: 'Doctor discussed harms of lung cancer screening' },
            { group: 'Lung cancer screening', value: 'Lung21', text: 'Ever had low-dose CT scan of chest area' },
            { group: 'Lung cancer screening', value: 'Lung22', text: 'Most recent low-dose CT scan of chest area to check for lung cancer' },
            { group: 'Lung cancer screening', value: 'Lung23', text: 'Doctor never recommended' },
            { group: 'Lung cancer screening', value: 'Lung24', text: 'Healthy' },
            { group: 'Lung cancer screening', value: 'Lung25', text: 'Afraid of being judged/blamed for smoking' },
            { group: 'Lung cancer screening', value: 'Lung26', text: 'Hard to find time' },
            { group: 'Lung cancer screening', value: 'Lung27', text: 'Hard to get reliable transportation' },
            { group: 'Lung cancer screening', value: 'Lung28', text: 'Concerned about exposure to radiation' },
            { group: 'Lung cancer screening', value: 'Lung29', text: 'Concerned about other harms' },
            { group: 'Lung cancer screening', value: 'Lung30', text: 'At low or no risk of getting lung cancer' },
            { group: 'Lung cancer screening', value: 'Lung31', text: 'Knowing the results would cause anxiety or stress' },
            { group: 'Lung cancer screening', value: 'Lung32', text: 'Concerned about the cost' },
            { group: 'Lung cancer screening', value: 'Lung33', text: 'Some other reason' }
        ]
    };
    ...
    document.getElementById('group-filter').addEventListener('change', function () {
        ...
        if (selectedGroup === 'Lyme') {
            topicFilter.value = 'Lyme1'; // Default for Stroke Test group
        } else if (selectedGroup === 'GLP') {
            topicFilter.value = 'GLP5'; // Default for PPP Health group
        } else if (selectedGroup === 'Lung') {
            topicFilter.value = 'Lung19'; // Default for HPV Health group
        }
