...
//        }
    ...
    const topics = {
        family: [
            { value: 'Familyhealthhistory13', text: 'Believe knowing family health history is somewhat or very important' },
            { value: 'Familyhealthhistory19', text: 'Know at least some of mother\'s health history' },
            { value: 'Familyhealthhistory17', text: 'Know at least some of father\'s health history' },

            { value: 'Familyhealthhistory18', text: 'Know at least some of maternal grandparents\' health history' },
            { value: 'Familyhealthhistory20', text: 'Know at least some of paternal grandparents\' health history' },
            { value: 'Familyhealthhistory14', text: 'Ever actively collected health information for family health history' },
            { value: 'Familyhealthhistory16', text: 'Ever shared family health history with other relatives' },
            { value: 'Familyhealthhistory15', text: 'Ever shared family health history with other relatives' },
            { value: 'Familyhealthhistory25', text: 'Ever shared family health history with doctor' },
            { value: 'Familyhealthhistory21', text: 'Think it\'s at least somewhat difficult to collect health history information' },
            { value: 'Familyhealthhistory22', text: 'Not knowing what to collect makes collecting health history difficult' },
            { value: 'Familyhealthhistory23', text: 'No contact with or deceased relatives makes collecting health history difficult' },
            { value: 'Familyhealthhistory26', text: 'Discomfort asking relatives makes collecting health history difficult' },
            { value: 'Familyhealthhistory24', text: 'Some other reason makes collecting health history difficult' },
            // Add more family health history topics here
        ],
        genetic: [
            { value: 'Genetictesting31', text: 'Ever had genetic test for risk of cancer or heart disease' },
            { value: 'Genetictesting33', text: 'Interested in genetic test for risk of cancer or heart disease' },
            { value: 'Genetictesting41', text: 'Want to share genetic test results with their relatives' },
            { value: 'Genetictesting39', text: 'Knowing genetic testing results would affect their healthcare decisions' },
            { value: 'Genetictesting40', text: 'Knowing genetic testing results would encourage a change in health habits' },
            { value: 'Genetictesting38', text: 'A doctor recommended genetic testing' },
        ...
        sexual: [
            {
                ...
                options: [
                    // { value: '', text: '\n<b>Sexual Health</b>' },
                    { value: 'Sexualhealth65', text: 'Received any sexual health services, past 12 months' },
                    { value: 'Sexualhealth64', text: 'Received sexual health services in doctor\'s office' },
                    { value: 'Sexualhealth60', text: 'Received sexual health services in a community or public health clinic' },
                    { value: 'Sexualhealth61', text: 'Received sexual health services in a hospital/emergency room' },
                    { value: 'Sexualhealth63', text: 'Received sexual health services in an urgent care or in-store health clinic' },
                    { value: 'Sexualhealth62', text: 'Received sexual health services in a telehealth appointment' },
                ]
            },
            {
                label: 'Sources for Sexual Health Information',
                options: [
            { value: 'Sexualhealth72', text: 'Turned to their family for information on sexual health<' }, ,
            { value: 'Sexualhealth73', text: 'Turned to their partner for information on sexual health' },
            { value: 'Sexualhealth74', text: 'Turned to their peers or friends for information on sexual health' },
            { value: 'Sexualhealth75', text: 'Turned to their therapist for information on sexual health' },
            { value: 'Sexualhealth71', text: 'Turned to their doctor for information on sexual health' },
            { value: 'Sexualhealth70', text: 'Turned to the internet or social media for information on sexual health' },
            { value: 'Sexualhealth69', text: 'Turned to another source for information on sexual health' },
        ...
        topicFilter.innerHTML = ''; // Clear previous options
            ...
            if (selectedGroup === 'sexual') {
                topics[selectedGroup].forEach(group => {
                    const optgroup = document.createElement('optgroup');
                    optgroup.label = group.label;
                    group.options.forEach(topic => {
