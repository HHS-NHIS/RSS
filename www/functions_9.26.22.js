...
//    str = str2.replaceall(",Jan-Mar", "Q1")
...
function myFunction2() {
    ...
    //   height: height,
       ...
       hovertemplate: "%{x:1} " + "(" + "%{text}" + ")" + "<extra></extra>",
       //hovertemplate: "%{y} " + "%{x:1} " + "("+ "%{text}"+")"+ "<extra></extra>",
       //hovertemplate: "%{x:1} " + "(" + "%{text}" + ")" + "<extra></extra>",
     ...
     const LCLUCL_SEdiff = UCLdiff.concat(LCLdiff);
      ...
      var y_se3 = y_se.map(y_se => { return isNaN(y_se) ? avg : y_se });
       ...
       errnewSEor_y: {type: 'data', visible: showSEs, color: CI_color,symmetric: false,
           ...
           text2: y_lab[j],
           hoverlabel: { bgcolor: "white" },
           hovertemplate: "<br>%{x} <br>" + "%{y:1} " + "(" + "%{text}" + ")" + "<extra></extra>",
           //hovertemplate: "%{y_lab:1} "  +"%{y:1} " + "("+ "%{text}"+")"+  "<extra></extra>",
       //hoverinfo: "y"
       };
